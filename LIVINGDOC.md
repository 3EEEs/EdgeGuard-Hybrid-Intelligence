...
## Reflections:
- **Samuel Dressel**: I enjoyed working on this project a lot. This project taught me that I need to get better at time management skills. I learned a new web framework called Astro. I also learned how to properly add an automated testing software to a project. I also learned how to cause a web framework to interact with a python program using react endpoints. I did a good job with showing up to team meetings consistently and communicating with fellow team members. For future projects I need be better at keeping up with reading documentation made by other team members, understanding what other team mmebers were working and being more independent in my work. As a group member, I also should have contributed more to the codebase and helped others with their code more.
...
- **Ethan Short**: I enjoyed working on this project a lot! Focusing on the AWS side of things over the course of the last ten weeks has been a huge win for me. Through working on the s3 bucket, lambda, functions, dynamoDB and tying it all together I have learned how to use AWS in a practical application, and make it secure and reliable for real world deployment. There were many different moving parts to the project, and I'm glad to get experience while focusing on the image processing, also working on the front-end Astro framework as well as the backend python script doing the image move detection. If I could go back I wished we tried implmenting a visual around different detected object and gave the frontend just a little bit more time than we ended up allocating to huge. Overall huge success, would do it again!
- **Calvin Grabowski**: Working on the Motion detection system was a blast. It taught me new skills using a camera through code. Once I learned how to grab frames from a live feed, I was able to make background subtraction, followed by a scoring method of what frames would be best to choose in a given motion. This pushed my creativity in the way how I started the clips. Enabling me to extract the "best" frames possible by focusing on centralized movement, and lack of blur. Overall, I learned a lot about extracting data from frames and using them to gain insight. With everything completed we noticed an upwards of 90% reduction in environmental noise (birds, bugs, movements we don't care about).
