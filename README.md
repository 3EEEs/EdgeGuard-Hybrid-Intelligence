...
| :--- | :--- | :--- |
| **Ethan Short** | Motion Detection Lead | TBD |
| **Calvin Grabowski** | API & Cloud Interaction Lead | TBD |
| **Michael Wilde** | Video Processing Lead | TBD |
| **Samuel Dressel** | Motion Detection & Storage Optimization Lead | TBD |
