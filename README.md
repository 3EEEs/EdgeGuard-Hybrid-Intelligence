...
* **`/docs`** Contains project documentation, including cloud setup, developer guide, interfaces, and user manuel

* **`/edgeguard-frontend`** Contains astro, node, logos, images, src folder with components, with astro and javascript with react files. This would also be the folder where an environment folder needs to be created with keys to the AWS. This should NEVER be pushed to github

* **`node`** Contains json files for python to run node
...
* **`/tests`** Contains integration, system, unit, and test scripts to ensure system reliability.

**Other Files**

* **`.gitignore`** that stops pushing important data or computer specific details

* **`LIVINGDOC.md`** Contains all our progress during the project and what we added

* **`json`** For dependencies

* **`README.md`** This file containing an overview of the project

* **`run_project.py`** Runs the requirements.txt/ updates dependencies, and then runs the front and backend together so we can run the program
...
To install and setup the software please refer to [INSTALL.md](https://github.com/3EEEs/EdgeGuard-Hybrid-Intelligence/blob/main/docs/INSTALL.md) and [SETUP.md](https://github.com/3EEEs/EdgeGuard-Hybrid-Intelligence/blob/main/docs/SETUP.md)
