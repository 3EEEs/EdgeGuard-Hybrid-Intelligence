...
This document defines the data structures and communication protocols between the Edge, Cloud, and Web Dashboard components. 

---
## 1. Frontend ↔ Cloud (Data Retrieval)
The Web Dashboard polls the AWS backend to populate the `Event_Feed.jsx` component.
